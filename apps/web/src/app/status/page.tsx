    ...
    <div className="pg">
      ...
      <div className="grid2">
        ...
        <div className="box">
          ...
          <div className="kv"><span>Active dataset</span><span className="mono">{DEMO_DATASET}</span></div>
          ...
          <div className="kv"><span>GPT-4o extraction</span><b>requires OPENAI_API_KEY</b></div>
      ...
      <div className="box">
        ...
        <table className="tbl"><tbody>
          ...
          <tr><td className="mono">OPENAI_API_KEY</td><td>server-side required for audio session processing</td></tr>
          <tr><td className="mono">COGNEE_SERVICE_URL</td><td className="mono">http://localhost:8001</td></tr>
          <tr><td className="mono">NEXT_PUBLIC_API_BASE_URL</td><td className="mono">{API_BASE || "same-origin /api"}</td></tr>
          <tr><td className="mono">LLM_MODEL</td><td className="mono">gpt-4o</td></tr>
